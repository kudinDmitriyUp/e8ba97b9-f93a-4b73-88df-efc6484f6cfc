...
export const metadata: Metadata = {
  title: "Alpine Luxe Switzerland | 5-Star Luxury Hotel",
  description: "Experience unparalleled luxury in the heart of the Swiss Alps at Alpine Luxe. World-class accommodations, Michelin-starred dining, and bespoke services.",
  keywords: "luxury hotel Switzerland, Alpine resort, 5-star hotel, Swiss hospitality, mountain luxury",
  metadataBase: new URL("https://alpineluxe.ch"),
  alternates: {
    canonical: "https://alpineluxe.ch"
  },
  openGraph: {
    title: "Alpine Luxe Switzerland | Luxury Alpine Hotel",
    description: "Discover luxury hospitality in the Swiss Alps with stunning mountain views and world-class amenities.",
    siteName: "Alpine Luxe Switzerland",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764379907837-vql07khh.jpg",
      alt: "Alpine Luxe luxury hotel in Swiss mountains"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Alpine Luxe Switzerland",
    description: "Experience luxury in the heart of the Swiss Alps",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764379907837-vql07khh.jpg"]
  },
  robots: {
    index: true,
    follow: true
